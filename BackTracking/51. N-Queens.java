class Solution {
    ...
    public static List<List<String>> solveNQueens11(int n) {
    ...
    static void dfs(int col, char[][] board, List<List<String>> result) {
        if (col == board.length) {
    ...
    static boolean validate(char[][] board, int row, int col) {
        ...
        row = duprow;
        col = dupcol;
        while (col >= 0 && row < board.length) { // lower diagonal
            if (board[row][col] == 'Q') return false;
            col--;
            row++;
        }
